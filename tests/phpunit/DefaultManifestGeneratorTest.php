...
class DefaultManifestGeneratorTest extends TestCase
{
    ...
    public function testCsvWithoutHeaderTableQueryCaseInsensitivePk(): void
    {
        $exportConfig = $this->createExportConfig(['PK1', 'pk2']);
        $exportResult = $this->createExportResult();
    ...
    public function testCsvWithoutHeaderTableQueryCaseInsensitivePkLegacyFormat(): void
    {
        $exportConfig = $this->createExportConfig(['PK1', 'pk2']);
        $exportResult = $this->createExportResult();
    ...
    public function testCsvWithoutHeaderCustomQueryCaseInsensitivePk(): void
    {
        $exportConfig = $this->createExportConfig(['PK1', 'pk2']);
        $exportResult = $this->createExportResult();
        $queryMetadata = $this
    ...
    public function testCsvWithoutHeaderCustomQueryCaseInsensitivePkLegacyFormat(): void
    {
        $exportConfig = $this->createExportConfig(['PK1', 'pk2']);
        $exportResult = $this->createExportResult();
        $queryMetadata = $this
